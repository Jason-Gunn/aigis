...
class AIGIS_REST_Guardrail extends AIGIS_REST_Controller {
	...
	public function check_guardrail_access( \WP_REST_Request $request ): bool|\WP_Error {
		return $this->check_authenticated_access(
			$request,
			[
				AIGIS_Capabilities::USE_PROMPTS,
				AIGIS_Capabilities::MANAGE_EVAL,
			]
		);
	}
	...
	public function register_routes(): void {
		register_rest_route( $this->namespace, '/guardrail-trigger', [
			[
				...
				'permission_callback' => [ $this, 'check_guardrail_access' ],
